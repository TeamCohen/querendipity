...
<%@ taglib uri="http://ajaxtags.sourceforge.net/tags/ajaxtags" prefix="ajax"%>
  ...
  var nstepsCutoffPoints = [{ 
  	over:1000, msg:"<span id=\"nstepsMsg\">Slow search, more complete sample</span>"
  }, {
  	over: 300, msg:"<span id=\"nstepsMsg\">Reasonable speed, partial sample</span>"
  }, {
  	over:0,    msg:"<span id=\"nstepsMsg\">Fast search, sparse sample</span>"
  }];
  var depthCutoffPoints = [{
  	over:10,   msg:"<span id=\"depthMsg\">Very slow search, risking unrelated results</span>"
  }, {
  	over:6,    msg:"<span id=\"depthMsg\">Slow search, going farther afield</span>"
  }, {
  	over: 3,   msg:"<span id=\"depthMsg\">Reasonable speed, near vicinity of keywords</span>"
  }, {
  	over:0,    msg:"<span id=\"depthMsg\">Fast search, directly related to keywords</span>"
  }];
...
<input type="hidden" name="searchform"   id="searchform"   value="Basic"/>
...
<s:if test="searchAction == 'MergedSearch'">
  ...
  <tr class="hdivider" style="display:none"><td>New features (beta):</td>
